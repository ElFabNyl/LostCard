...
import 'custom_lost_notification_dialog.dart';

class CustomLostCard extends StatefulWidget {
  void Function()? onPressed;

  CustomLostCard({Key? key, this.onPressed}) : super(key: key);

  CustomLostCardState createState() => CustomLostCardState();
}

class CustomLostCardState extends State<CustomLostCard> {
  @override
