...
class RegisterFoundDocumentPictures extends StatefulWidget{

  RegisterFoundDocumentPicturesState createState() => RegisterFoundDocumentPicturesState();
}

class RegisterFoundDocumentPicturesState extends State<RegisterFoundDocumentPictures>{
  @override
                      ...
                      onPressed: (){
                        showDialog(
                            ...
                            builder: (BuildContext context) {
                              return SuccessRegisteredPostDialog(textMessage: 'We have successfully registered the document you found on our platform');
                            });
                      },
