...
import 'package:lostcard/view/signal_document_loss/alert_dialog_document_upload.dart';
import 'package:lostcard/view/signal_document_loss/signal_document_loss_pictures.dart';

class SignalDocumentLossDocumentInformation extends StatefulWidget{
  const SignalDocumentLossDocumentInformation({Key? key}) : super(key: key);


  @override
  SignalDocumentLossDocumentInformationState createState() =>SignalDocumentLossDocumentInformationState();



}

class SignalDocumentLossDocumentInformationState extends State<SignalDocumentLossDocumentInformation>{
  @override
                    ...
                    CustomizedTextButton(
                      ...
                      onPressed: (){
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => SignalDocumenttLossPictures()),
                        );

                        showDialog(
                            context: context,
                            builder: (BuildContext context) {
                              return  AlertDialogDocumentUpload();
                            });
                      },
